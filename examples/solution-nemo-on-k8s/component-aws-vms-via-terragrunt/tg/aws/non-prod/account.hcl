...
locals {
  # E.g. for personal acct in US-EAST-2, AWS account ID is here:
  #   https://us-east-2.console.aws.amazon.com/billing/home?region=us-east-2#/account
  aws_account_id = "792566780889"

  # These might not used, but they are useful as labels/docs
